    ...
    <div className="w-screen h-screen ">
      ...
      <div className="content flex  ">
                  ...
                  <SheetDescription className="text-slate-400">
                    <div className="text-slate-400 flex flex-col  w-[50px] m-auto h-70% justify-evenly   gap-6 ">
                      <div>
                        <Link
                          target="blank"
                          href={"https://twitter.com/AliPythonDev"}
                        >
                          <img
                      ...
                      <div>
                        <Link
                          target="blank"
                          href={"https://github.com/AliPythonDev"}
                        >
                          <img
                            src="/githubwhite.png"
                      ...
                      <div>
                        <Link
                          target="blank"
                          href={"https://www.linkedin.com/in/AliPythonDev"}
                        >
                          {" "}
                          <img
        ...
        <div className=" flex-col hidden md:flex h-screen justify-center m-5 gap-6  mt-28">
          <div>
            <Link target="blank" href={"https://twitter.com/AliPythonDev"}>
              <img
                src="/twitterWhite.png"
                className="cursor-pointer"
                width={37}
          ...
          <div>
            <Link target="blank" href={"https://github.com/AliPythonDev"}>
              <img
                src="/githubwhite.png"
                className="cursor-pointer"
                width={37}
